...
import de.hasselmeyer.leanangle.MainViewModelConfig.AUTO_PAUSE_LEAN_THRESHOLD
import de.hasselmeyer.leanangle.MainViewModelConfig.MAX_LEAN_DEG
import de.hasselmeyer.leanangle.data.Vec3
import de.hasselmeyer.leanangle.sensor.BikeFrameMath
import de.hasselmeyer.leanangle.sensor.CalibrationTiltProgress
import de.hasselmeyer.leanangle.sensor.FusionGating
import de.hasselmeyer.leanangle.sensor.SensorTraceSample
import de.hasselmeyer.leanangle.sensor.fusionDeltaSeconds
...
internal fun MainViewModel.resetSensorFusion() {
    ...
    fusionQuaternion = de.hasselmeyer.leanangle.sensor.Quaternion.IDENTITY
