...
import de.hasselmeyer.leanangle.MainViewModelConfig.GPS_FRESHNESS_THRESHOLD_MS
import de.hasselmeyer.leanangle.MainViewModelConfig.LIVE_POINTS_UI_LIMIT
import de.hasselmeyer.leanangle.MainViewModelConfig.RECORDER_INTERVAL_MAX_MS
import de.hasselmeyer.leanangle.MainViewModelConfig.RECORDER_INTERVAL_MIN_MS
...
internal fun MainViewModel.dismissAutoResumePremiumShortcut() {
...
internal fun MainViewModel.finishRide() {
    ...
    if (currentRideId != null) {
        if (ridePointCount > 0) {
            ...
            val stats = de.hasselmeyer.leanangle.data.RideStats(
