...
fun calculateRouteDescription(context: Context, session: RideSession): String? {
    ...
    // For very long rides, sample points to keep performance high
    ...
    // 3. Detect major stops (> 10 mins)
    // Sample intermediate points and limit Geocoder calls to avoid blocking
