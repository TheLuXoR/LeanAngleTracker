...
fun BikeLeanAnimation(step: CalibrationStep, modifier: Modifier = Modifier) {
    ...
    Canvas(modifier = modifier) {
        ...
        withTransform({
            ...
            drawOval(Color.Black.copy(alpha = 0.2f), Offset(centerX - 20.dp.toPx(), groundY - 5.dp.toPx()), Size(40.dp.toPx(), 10.dp.toPx()))
            drawRoundRect(Color(0xFF1A1C1E), Offset(centerX - 14.dp.toPx(), groundY - 60.dp.toPx()), Size(28.dp.toPx(), 60.dp.toPx()), CornerRadius(14.dp.toPx()))
