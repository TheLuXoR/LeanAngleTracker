...
- **Status**: Implemented
- **Products**: `automation_pack_unlock` is a permanent one-time Automation Pack unlock; `premium_subscription` is the subscription that unlocks all premium features and removes ads.
